...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "setup-dev-tools", type: "shell", inline: <<-SHELL
    ...
    choco install -y visualstudio2019community --package-parameters "--installPath ""C:\\VS"" --add Microsoft.VisualStudio.Component.VC.Tools.x86.x64 --add Microsoft.VisualStudio.Component.VC.CoreBuildTools --add Microsoft.VisualStudio.Component.VC.Redist.14.Latest --add Microsoft.VisualStudio.Component.Windows10SDK --add Microsoft.VisualStudio.Component.Windows10SDK.18362 --includeRecommended --passive --wait"
    C:\\Python39\\Scripts\\pip.exe install conan
  SHELL

  config.vm.provision "build-llvm", type: "shell", inline: <<-SHELL
    cd $HOME
    git clone -b llvmorg-11.0.0 --depth 1 https://github.com/llvm/llvm-project.git
    mkdir llvm-build
    cd llvm-build
    cmd.exe /C "C:\\VS\\VC\\Auxiliary\\Build\\vcvars64.bat && cmake -G Ninja ../llvm-project/llvm -DLLVM_ENABLE_DIA_SDK=OFF -DCMAKE_BUILD_TYPE=RelWithDebInfo"
